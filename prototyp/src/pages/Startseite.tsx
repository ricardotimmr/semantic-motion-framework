...
function Startseite({ currentPage, onNavigate }: PageProps) {
      ...
      <main className="main-content">
        <section className="hero-section">
          <div className="hero-copy">
            <p className="eyebrow">
              Bachelorarbeit · Medieninformatik · TH Köln
            </p>
            <h1>
              UI-Animation mit
              <br />
          ...
          <div className="easing-card" aria-label="Easing-Demo">
            ...
            <p className="demo-note">
              Hinweis: Die Demo visualisiert die Kurven didaktisch verstärkt.
              Die produktiven Mapping-Werte sind in der Framework-Dokumentation
              definiert.
            </p>
          </div>
        </section>
        ...
        <section className="quote-section">
          <div>
            <p className="quote-text">
              Designer gestalten Bedeutungsangebote, nicht nur Formen. Motion
              wird damit zu einem Teil der semantischen Oberfläche.
            </p>
